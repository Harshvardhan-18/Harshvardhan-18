...
if __name__ == '__main__':
    """
    Harshvardhan profile generator
    """
    ...
    # TODO: replace with your own date of birth (or swap for account creation date
    # via acc_date above if you'd rather not publish your birthday)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2024, 11, 13))
